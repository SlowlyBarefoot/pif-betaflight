...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_FILTER] = DEFINE_TASK("FILTER", NULL, TM_EXTERNAL, taskFiltering, TASK_GYROPID_DESIRED_PERIOD),
    [TASK_PID] = DEFINE_TASK("PID", NULL, TM_EXTERNAL, taskMainPidLoop, TASK_GYROPID_DESIRED_PERIOD),
#ifdef USE_ACC
