...
void gpsInit(void)
{
    ...
    if (!pifUart_AttachTxTask(&gpsPort->uart, PIF_ID_AUTO, TM_EXTERNAL, 0, "UART-TX-GPS")) return;
    if (!pifUart_AttachRxTask(&gpsPort->uart, PIF_ID_AUTO, TM_PERIOD, 2000, "UART-RX-GPS")) return;      // 2000ms
