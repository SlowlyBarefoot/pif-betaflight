...
// Gives up on a transfer that ran past its timeout without i2cWait() having
// seen it, and recovers the bus the way the driver does after its own
// timeouts. Counts as an I2C error.
