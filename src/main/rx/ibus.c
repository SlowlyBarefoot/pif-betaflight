...
bool ibusInit(const rxConfig_t *rxConfig, rxRuntimeState_t *rxRuntimeState)
{
    ...
    serialPort_t *ibusPort = openSerialPort(portConfig->identifier,
        ...
        pifUart_AttachTxTask(&ibusPort->uart, PIF_ID_AUTO, TM_EXTERNAL, 0, "UART-TX_IBUS");
        pifUart_AttachRxTask(&ibusPort->uart, PIF_ID_AUTO, TM_PERIOD, 2000, "UART-RX_IBUS");         // 2000ms
